		...
		>
			<FlexBetween m='1rem 2.5rem'gap='1rem'>
				<Box>
					...
					<Typography variant="h6">Charted revenue and predicted revenue based on a simple linear regression</Typography>
				</Box>
				<Button variant='contained' onClick={() => setIsPredictions(!isPredictions)}
				sx={{
